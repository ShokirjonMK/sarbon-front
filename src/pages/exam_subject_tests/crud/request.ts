...
export async function submitExamTest(id: string | undefined, data: any) {
  ...
  formdata.append("language_id", data["lang_id"]);
  formdata.append("type", "2");
  if (data["exam_type_id"])
    formdata.append("exam_type_id", data["exam_type_id"]);
...
export async function importExamTestToExcel(
